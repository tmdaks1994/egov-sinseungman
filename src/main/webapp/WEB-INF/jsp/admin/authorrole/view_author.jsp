              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="${result.ROLE_PTTRN}" type="text" class="form-control" name="ROLE_PTTRN" id="ROLE_PTTRN" placeholder="화면URL" required readonly>
...
$(document).ready(function(){
	$("#btn_delete").on("click",function(){
		...
		if(confirm("정말로 삭제 하시겠습니까?")) {
			...
			delete_form.attr("action","<c:url value='/admin/author/delete_author.do' />");
			delete_form.submit();
		}
	});
});
